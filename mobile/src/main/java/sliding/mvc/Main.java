...
public class Main extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //WorkoutController wController = (WorkoutController) getApplicationContext();

        /*Parse.enableLocalDatastore(this);
        Parse.initialize(this, "KA6jprHrQVzFreYkI6kRkc8tzBQMhOouXlsC6RRt", "cL9PJAYd1F7WMYrHtCrmgnnhaOFfrmciAm86cvtb");
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            case 0:
                objFragment = new menu_fragment1();
                break;
            case 1:
                objFragment = new menu_fragment2();
                break;
            case 2:
                objFragment = new menu_fragment3();
                break;
        }
